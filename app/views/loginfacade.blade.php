...
<div class="content">
    ...
    <form class="login-form" action="" method="post">
        ...
        <div class="alert alert-danger <?php echo Session::get('error')? '': 'display-hide'; ?>">
            <button class="close" data-close="alert"></button>
			<span><?php echo Session::get('error')? Session::get('error'): 'Enter username and password.'?></span>
        </div>
