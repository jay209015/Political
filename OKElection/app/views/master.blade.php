...
<!--                <li><a href="#">Generate Full Report</a></li>-->
                ...
                <li {{$active == "uniquevotersincounties"? 'class="active"':''}}><a href="{{url('reports/unique-voters-per-county', $parameters = array(), $secure = null);}}">List Unique Voters Per County Per District</a></li>
<!--                <li class="divider"></li>
