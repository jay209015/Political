...
<form action="" method="POST" class="form-inline" role="form">
    <div class="form-group">
        ...
        <input type="text" class="form-control" id="county_code" name="county_code" value="" size="2" placeholder="17"/>
    </div>
    <div class="form-group">
        <label  for="election_dates">Dates</label>
        <input type="text" name="election_dates" id="election_dates" placeholder="<?=date('Ymd')?>"/>
    </div>
    <div class="form-group">
        <label  for="county_code">Appears in (n) of Dates (not yet functioning)</label>
        <input type="text" name="appears" placeholder="3"/>
    </div>
    <div class="form-group">
